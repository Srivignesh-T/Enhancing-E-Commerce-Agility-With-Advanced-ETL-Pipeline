...
# # Retrieve credentials and settings from environment
...
#         st.success(f"File '{s3_file_name}' uploaded successfully to {bucket}!")
#     except Exception as e:
#         st.error(f"Failed to upload file '{s3_file_name}': {e}")

# # Function to prepare the file and upload to S3
...
#     st.title("Orders and Returns File Uploader")
...
#         else:
#             st.warning("Please upload both the orders and the returns files.")
